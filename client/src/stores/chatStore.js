...
export const useChatStore = create((set, get) => ({
  ...
  createSession: async () => {
    ...
    // call. This prevents empty "New Chat" entries from cluttering the
    // sidebar when the user clicks "New Chat" but never sends a message.
  ...
  sendMessage: async (content) => {
    ...
    // just before sending the first message. This ensures sessions are only
    // created when the user actually sends a message — not when they click
    // "New Chat".
